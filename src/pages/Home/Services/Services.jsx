    ...
    return (
        <div className="mt-5">
            <div className="text-center">
                ...
                <p className="w-1/2 mx-auto mt-5">the majority have suffered alteration in some form, by injected humour, or randomised words which do not look even slightly believable. </p>
